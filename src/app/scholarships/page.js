  ...
  return (
    <>
      <PageHero
        ...
        backgroundImage="https://images.unsplash.com/photo-1532012197267-da84d127e765?w=1600&q=80&auto=format&fit=crop"
      />
      ...
      <section className="mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="mt-8 rounded-xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-800">
          <strong className="text-amber-900">Heads up:</strong> Stipend amounts, deadlines and eligibility criteria are updated every year.

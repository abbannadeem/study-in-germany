...
// Pakistani audience strongly prefers WhatsApp over forms/email, so this is a
// big conversion-friendly UX detail.
//
// Replace the phone number below with your real WhatsApp number.
const WHATSAPP_NUMBER = "923000000000"; // format: country code + number, no +
...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-all hover:scale-110 hover:bg-[#1ebe57] sm:h-16 sm:w-16"
    >
      {/* WhatsApp SVG icon */}
      <svg
        viewBox="0 0 24 24"

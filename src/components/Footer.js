          ...
          <div className="mt-5">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-gradient-to-br hover:from-purple-500 hover:via-pink-500 hover:to-orange-400"
              >
